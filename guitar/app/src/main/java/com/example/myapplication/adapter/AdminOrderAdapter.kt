...
import com.example.myapplication.activity.AdminOrderDetailActivity
...
class AdminOrderAdapter(private var orders: MutableList<Order>) :
    RecyclerView.Adapter<AdminOrderAdapter.ViewHolder>() {
    private val TAG = "AdminOrderAdapter"

    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val TAG = "AdminOrderAdapter ViewHolder"
        ...
        init {
            itemView.setOnClickListener(object : View.OnClickListener {
                ...
                override fun onClick(v: View?) {
                    var intent: Intent = Intent(itemView.context, AdminOrderDetailActivity::class.java)
