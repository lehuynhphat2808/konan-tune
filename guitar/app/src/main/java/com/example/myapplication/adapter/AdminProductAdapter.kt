...
class AdminProductAdapter(private var products: MutableList<Product>) :
    RecyclerView.Adapter<AdminProductAdapter.ViewHolder>() {
    private val TAG = "AdminProductAdapter"

    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val TAG = "AdminProductAdapter ViewHolder"
        ...
        init {
            ...
            itemView.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View?) {
                    ...
                    intent.putExtra("productId", productId) // Pass the selected product to the ProductDetailActivity
                    itemView.context.startActivity(intent)
                }
